...
var indexes      = {};
var watchers     = {};
var options      = Meteor.settings.elasticsearch;
// console.log(options);
...
function updateWatcher(watcher) {
	...
	var callback = function(error, results) {
		// console.log('updateWatcher callback');
		if(error) {
			throw new Error(error);
		}
...
Meteor.publish("Elasticity::search", function(key, name, body, limit, skip) {
	...
	// console.log(arguments);
	// console.log(indexes);
	var index      = indexes[Meteor.settings.elasticsearch.indexes[name]];
	// console.log(index);
	var collection = index.collection;
	var self       = this;
